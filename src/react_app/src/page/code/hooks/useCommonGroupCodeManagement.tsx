...
export function useCommonGroupCodeManagement() {
    ...
    const columns: TableColumnsType<ComGrpCdList> = [
        ...
        },
        {
            title: '관리항목(문자형)',
            children: [
                {title: '문자형1', key: 'ref01', dataIndex: 'ref01', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={200} onChange={(e) => handleDataChange(record, 'ref01', e.target.value)}/>},
                {title: '문자형2', key: 'ref02', dataIndex: 'ref02', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={200} onChange={(e) => handleDataChange(record, 'ref02', e.target.value)}/>},
                {title: '문자형3', key: 'ref03', dataIndex: 'ref03', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={200} onChange={(e) => handleDataChange(record, 'ref03', e.target.value)}/>},
                {title: '문자형4', key: 'ref04', dataIndex: 'ref04', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={200} onChange={(e) => handleDataChange(record, 'ref04', e.target.value)}/>},
                {title: '문자형5', key: 'ref05', dataIndex: 'ref05', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={200} onChange={(e) => handleDataChange(record, 'ref05', e.target.value)}/>},
            ],
        },
        {
            title: '관리항목(정수형)',
            children: [
                {title: '정수형1', key: 'ref06', dataIndex: 'ref06', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={20} onChange={(e) => handleDataChange(record, 'ref06', e.target.value)}/>},
                {title: '정수형2', key: 'ref07', dataIndex: 'ref07', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={20} onChange={(e) => handleDataChange(record, 'ref07', e.target.value)}/>},
                {title: '정수형3', key: 'ref08', dataIndex: 'ref08', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={20} onChange={(e) => handleDataChange(record, 'ref08', e.target.value)}/>},
                {title: '정수형4', key: 'ref09', dataIndex: 'ref09', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={20} onChange={(e) => handleDataChange(record, 'ref09', e.target.value)}/>},
                {title: '정수형5', key: 'ref10', dataIndex: 'ref10', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={20} onChange={(e) => handleDataChange(record, 'ref10', e.target.value)}/>},
            ],
        },
        {
            title: '관리항목(실수형)',
            children: [
                {title: '실수형1', key: 'ref11', dataIndex: 'ref11', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={30} onChange={(e) => handleDataChange(record, 'ref11', e.target.value)}/>},
                {title: '실수형2', key: 'ref12', dataIndex: 'ref12', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={30} onChange={(e) => handleDataChange(record, 'ref12', e.target.value)}/>},
                {title: '실수형3', key: 'ref13', dataIndex: 'ref13', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={30} onChange={(e) => handleDataChange(record, 'ref13', e.target.value)}/>},
                {title: '실수형4', key: 'ref14', dataIndex: 'ref14', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={30} onChange={(e) => handleDataChange(record, 'ref14', e.target.value)}/>},
                {title: '실수형5', key: 'ref15', dataIndex: 'ref15', align: 'center', width: 100, render: (value: string, record: ComGrpCdList) => <CustomInput value={value} maxLength={30} onChange={(e) => handleDataChange(record, 'ref15', e.target.value)}/>},
            ],
        },
    ];
