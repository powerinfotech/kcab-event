    ...
    const comCdColumns: TableColumnsType<ComCdList> = [
        ...
        },
        {
            ...
            children: [
                ...
                {title: '문자형4', key: 'refval04', dataIndex: 'refval04', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={100} onChange={(e) => handleDataChange(record, 'refval04', e.target.value)}/>},
                {title: '문자형5', key: 'refval05', dataIndex: 'refval05', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={100} onChange={(e) => handleDataChange(record, 'refval05', e.target.value)}/>},
            ],
        },
        {
            title: '관리항목(정수형)',
            children: [
                {title: '정수형1', key: 'refval06', dataIndex: 'refval06', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={20} regExp={integerRegExp} onChange={(e) => handleDataChange(record, 'refval06', e.target.value)}/>},
                {title: '정수형2', key: 'refval07', dataIndex: 'refval07', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={20} regExp={integerRegExp} onChange={(e) => handleDataChange(record, 'refval07', e.target.value)}/>},
                {title: '정수형3', key: 'refval08', dataIndex: 'refval08', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={20} regExp={integerRegExp} onChange={(e) => handleDataChange(record, 'refval08', e.target.value)}/>},
                {title: '정수형4', key: 'refval09', dataIndex: 'refval09', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={20} regExp={integerRegExp} onChange={(e) => handleDataChange(record, 'refval09', e.target.value)}/>},
                {title: '정수형5', key: 'refval10', dataIndex: 'refval10', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={20} regExp={integerRegExp} onChange={(e) => handleDataChange(record, 'refval10', e.target.value)}/>},
            ],
        },
        {
            title: '관리항목(실수형)',
            children: [
                {title: '실수형1', key: 'refval11', dataIndex: 'refval11', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={30} regExp={floatRegExp} onChange={(e) => handleDataChange(record, 'refval11', e.target.value)}/>},
                {title: '실수형2', key: 'refval12', dataIndex: 'refval12', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={30} regExp={floatRegExp} onChange={(e) => handleDataChange(record, 'refval12', e.target.value)}/>},
                {title: '실수형3', key: 'refval13', dataIndex: 'refval13', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={30} regExp={floatRegExp} onChange={(e) => handleDataChange(record, 'refval13', e.target.value)}/>},
                {title: '실수형4', key: 'refval14', dataIndex: 'refval14', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={30} regExp={floatRegExp} onChange={(e) => handleDataChange(record, 'refval14', e.target.value)}/>},
                {title: '실수형5', key: 'refval15', dataIndex: 'refval15', align: 'center', width: 100, render: (value: string, record: ComCdList) => <CustomInput value={value} maxLength={30} regExp={floatRegExp} onChange={(e) => handleDataChange(record, 'refval15', e.target.value)}/>},
            ],
        },
    ];
