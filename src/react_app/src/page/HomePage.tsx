...
const expectationCards = [
  {
    title: 'Conference',
    desc: 'Plenary sessions and panels led by the Asia-Pacific\'s foremost arbitration leaders.',
    image: GalleryConferenceImage,
  },
  {
    title: 'Networking',
    desc: 'Receptions, dinners and side events that build lifelong professional ties.',
    image: GalleryReceptionImage,
  },
  {
    title: 'Collaboration',
    desc: 'Cross-border partnerships forged between firms, institutions and arbitrators.',
    image: GalleryNetworkImage,
  },
  {
    title: 'Knowledge',
    desc: 'Masterclasses and workshops curated for the next generation of practitioners.',
        ...
        <section className="saf-renewal-expect" id="program">
          <div className="saf-renewal-shell">
            <div className="saf-renewal-section-heading">
              <span className="saf-renewal-pill">What to Expect</span>
              <h2>
                SAF: Where We Connect
                <br />
                <strong>Across Borders</strong>
              </h2>
              <p>
                Five days. Hundreds of practitioners. One city built for dialogue.
                Every session, every reception and every encounter is designed so that
                real connections - and real agreements - can take shape.
              </p>
            </div>
        ...
        <section className="saf-renewal-recap">
          <div className="saf-renewal-shell saf-renewal-recap-grid">
            ...
            <div className="saf-renewal-recap-copy">
              <span className="saf-renewal-pill">Looking Back</span>
              <h2>
                Highlights of
                <br />
                SAF 2025
