    ...
    return <>
        <section className="title-wrap">
            <div className="box-flex">
                <h2 className="title">사용자별 메뉴권한</h2>
                ...
                <Breadcrumb
                    ...
                    items={[
                        ...
                        },
                        {
                            title: (
                                <>
                                    <span className="txt">사용자별 메뉴권한</span>
                                </>
                            ),
                        },
                    ]}
        ...
        <section className="board-wrap half-wrap type02">
            <div>
                ...
                <div className="board-cont-wrap">
                    <CustomTable rowKey={'id'} pagination={false} rowNoFlag={true} columns={columns1} dataSource={data1}/>
                </div>
            </div>
