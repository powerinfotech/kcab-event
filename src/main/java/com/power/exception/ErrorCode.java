 ...
 *       <td>{@link com.power.exception.custom.BusinessException}</td></tr>
 *   <tr><td>INVALID_PARAMETER_ERROR</td><td>452</td><td>입력값 검증 실패</td>
 *       <td>{@link com.power.exception.custom.ValidationException},
 *           {@code MethodArgumentNotValidException}</td></tr>
 *   <tr><td>INVALID_SESSION_ERROR</td><td>453</td><td>세션 만료/미인증</td>
 *       <td>{@link com.power.exception.custom.InValidSessionException}</td></tr>
 * </table>
 *
 * <h3>프론트엔드 연동</h3>
