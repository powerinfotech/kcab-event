package com.power.exception.custom;

import com.power.exception.ErrorCode;
 ...
 * {@link com.power.config.interceptor.SessionCheckInterceptor}에서 자동으로 발생시키며,
 * {@link com.power.exception.GlobalExceptionResolver}가 이를 잡아
