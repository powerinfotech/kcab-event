 ...
 *
 * <p>Reflections 라이브러리를 통해 {@code com.power.enums} 패키지의 모든 열거형을 스캔하고,
 ...
 *   <li>{@code value} 필드가 없는 열거형(예: {@link com.power.enums.IudType})은 자동으로 제외된다.</li>
 * </ul>
 *
 * <h3>사용 예시</h3>
 * <pre>
 ...
 * </pre>
 *
 * @see com.power.controller.CommonCodeController
 */
@Component
public class EnumCodeUtil {
    ...
    /**
     * {@code com.power.enums} 패키지의 모든 열거형을 스캔하여
