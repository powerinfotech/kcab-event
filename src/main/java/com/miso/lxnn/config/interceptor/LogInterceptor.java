 ...
 *
 * <p>{@link com.miso.lxnn.config.WebMvcConfig#addInterceptors}에서 order=2로 등록된다
 * ({@link SessionCheckInterceptor} 다음에 실행).</p>
 *
 * <h3>로그 출력 예시</h3>
 * <pre>
 * ----------new REQUEST------------
 * REQUEST [/api/users][com.miso.lxnn.controller.UserController#getUsers()] | uuid : [a1b2c3d4-...]
 * postHandler [null]
 * RESPONSE [/api/users][com.miso.lxnn.controller.UserController#getUsers()] | uuid : [a1b2c3d4-...]
 * </pre>
 *
 * <h3>UUID 흐름</h3>
 * <ol>
