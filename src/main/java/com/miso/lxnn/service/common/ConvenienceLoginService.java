 ...
 *
 * @see com.miso.lxnn.service.common.impl.ConvenienceLoginServiceImpl
 * @see com.miso.lxnn.controller.ConvenienceLoginController
 */
public interface ConvenienceLoginService {
     ...
     * @throws com.miso.lxnn.exception.custom.BusinessException 사용자 정보가 없을 경우
     */
