...
import com.kcabEvent.KcabEventApplication;
 ...
 *
 * <p>Reflections 라이브러리를 통해 {@code com.kcabEvent.enums} 패키지의 모든 열거형을 스캔하고,
 ...
 *   <li>{@code value} 필드가 없는 열거형(예: {@link com.kcabEvent.enums.IudType})은 자동으로 제외된다.</li>
 * </ul>
 *
 * <h3>사용 예시</h3>
 * <pre>
 ...
 * </pre>
 *
 * @see com.kcabEvent.controller.CommonCodeController
 */
@Component
public class EnumCodeUtil {
    private static  final String ENUM_PATH = KcabEventApplication.class.getPackageName()+".enums.";
    /** 코드 값으로 사용할 enum 필드명 (기본값) */
    public static final String TEXT_VALUE  = "value";


    /**
     * {@code com.kcabEvent.enums} 패키지의 모든 열거형을 스캔하여
