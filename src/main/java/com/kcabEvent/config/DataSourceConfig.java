 ...
 * <h3>설정 내용</h3>
 * <ul>
 *   <li>Mapper 스캔: {@code com.kcabEvent.dao} 패키지의 {@code @Mapper} 인터페이스를 자동 등록</li>
 *   <li>TypeAlias: {@code com.kcabEvent.domain} 패키지의 도메인 클래스를 MyBatis TypeAlias로 등록
...
@MapperScan(basePackages = "com.kcabEvent.dao")
public class DataSourceConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(DataSource dataSource) throws Exception {
        ...
        sqlSessionFactoryBean.setTypeAliasesPackage(KcabEventApplication.class.getPackageName() + ".domain");
